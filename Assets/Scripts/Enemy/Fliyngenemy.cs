...
public class Fliyngenemy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (Vector3.Distance(transform.position, TEST.sharedInstance.transform.position) > distanceToAttackPlayer)
            {
            ...
            else
            {
                ...
                if (attackTarget == Vector3.zero)
                {
                    ...
                    attackTarget = TEST.sharedInstance.transform.position;
                }
