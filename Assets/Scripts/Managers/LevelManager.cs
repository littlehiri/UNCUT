...
public class LevelManager : MonoBehaviour
{
    ...
    public IEnumerator RespawnPlayerCo()
    {
        ...
        TEST.sharedInstance.gameObject.SetActive(false);
        ...
        TEST.sharedInstance.gameObject.SetActive(true);
        //Lo ponemos en la posición de respawn
        TEST.sharedInstance.transform.position = CheckpointController.sharedInstance.spawnPoint;
    ...
    public IEnumerator ExitLevelCo()
    {
        ...
        TEST.sharedInstance.stopInput = true;
        //Paramos el movimiento del jugador
        TEST.sharedInstance.StopPlayer();
